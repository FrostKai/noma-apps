...
class _AddTransactionScreenState extends ConsumerState<AddTransactionScreen> {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            // Category Picker
            Text('Kategori', style: AppTypography.labelMedium),
            const SizedBox(height: 8),
            _buildCategoryPicker(categoriesAsync),
            const SizedBox(height: 20),

            // Payment Method Selector
            Text('Metode Pembayaran', style: AppTypography.labelMedium),
            const SizedBox(height: 8),
            _buildPaymentMethodPicker(),
            const SizedBox(height: 20),

            // Date Picker Card
            Text('Tanggal Transaksi', style: AppTypography.labelMedium),
            const SizedBox(height: 8),
            GlassCard(
              onTap: _selectDate,
              child: Row(
            ...
            children: [
              ...
              Expanded(
                child: TextField(
                  ...
                  style: AppTypography.amountDisplay.copyWith(color: AppColors.textPrimary),
  ...
  Widget _buildCategoryPicker(AsyncValue<List<Category>> categoriesAsync) {
    return categoriesAsync.when(
      ...
      error: (err, _) => Text('Error memuat kategori: $err', style: AppTypography.caption),
    );
  }
