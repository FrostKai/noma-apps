...
class ProductTourKeys {
  ...
  static GlobalKey settingsAiKey = GlobalKey(debugLabel: 'tour_settings_ai_key');
  static GlobalKey modalGroqBtn = GlobalKey(debugLabel: 'tour_modal_groq_btn');
  static GlobalKey modalGroqInput = GlobalKey(debugLabel: 'tour_modal_groq_input');
  static GlobalKey modalGeminiBtn = GlobalKey(debugLabel: 'tour_modal_gemini_btn');
  static GlobalKey modalGeminiInput = GlobalKey(debugLabel: 'tour_modal_gemini_input');
  static GlobalKey settingsCategory = GlobalKey(debugLabel: 'tour_settings_category');
  static GlobalKey settingsNotification = GlobalKey(debugLabel: 'tour_settings_notification');

  // ── Fase 3: Fitur Utama Beranda (Step 10-14) ──
  static GlobalKey navBeranda = GlobalKey(debugLabel: 'tour_nav_beranda');
  static GlobalKey dashboardChart = GlobalKey(debugLabel: 'tour_dashboard_chart');
  static GlobalKey aiSmartInput = GlobalKey(debugLabel: 'tour_ai_smart_input');
  static GlobalKey quickActions = GlobalKey(debugLabel: 'tour_quick_actions');
  ...
  static void refreshKeys() {
    ...
    quickActions = GlobalKey(debugLabel: 'tour_quick_actions');
